...
@Component({
  ...
  template: `
    ...
    <div class="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in"
      ...
      <div class="bg-slate-900 border border-slate-700 rounded-lg shadow-2xl w-full max-w-md p-6 relative"
        ...
        <div class="space-y-6">
          ...
          @if (config.provider === 'lm-studio') {
            ...
            <div class="p-4 bg-slate-950/50 rounded border border-slate-800/50 animate-fade-in-down">
